...
interface MessageRepository {
    ...
    suspend fun getMessages(userId1: String,userId2:String):Flow<Resource<List<Message>>>
    suspend fun sendMessage(message: Message):Flow<Resource<Boolean>>
    suspend fun markMessagesAsRead(senderId:String,receiverId:String):Flow<Resource<Boolean>>
}